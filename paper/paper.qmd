...
Using @fig-flowering-trend, we see a gradual shift in flowering dates over time. Earlier flowering events have become more common, particularly in modern years. This trend, captured by the loess regression, suggests an accelerating response to environmental changes. Similarly, @fig-temperature-trend reveals a steady increase in average March temperatures over the centuries, with notable warming in recent decades.
...
```{r}
#| label: fig-temp-vs-flowering
#| fig-cap: "Relationship Between Temperature and Flowering Date"
#| warning: false 
#| message: false
#| fig-align: center
...
## Flowering Ranges Across Decades

```{r}
#| label: fig-flowering-decade
#| fig-cap: "Flowering Range by Decade"
#| warning: false 
#| message: false
#| fig-align: center
